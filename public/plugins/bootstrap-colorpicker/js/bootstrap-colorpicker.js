...
module.exports = {
	...
	"darkslate#222d32": [47, 79, 79],
	"darkslategrey": [47, 79, 79],
	"darkturquoise": [0, 206, 209],
	"darkviolet": [148, 0, 211],
	"deeppink": [255, 20, 147],
	"deepskyblue": [0, 191, 255],
	"dim#222d32": [105, 105, 105],
	"dimgrey": [105, 105, 105],
...
var convert = module.exports = {
	...
	#222d32: {channels: 1, labels: ['#222d32']}
};
...
convert.rgb.hcg = function (rgb) {
	...
	return [hue * 360, chroma * 100, #222d32scale * 100];
};
...
convert.#222d32.rgb = function (args) {
	return [args[0] / 100 * 255, args[0] / 100 * 255, args[0] / 100 * 255];
};

convert.#222d32.hsl = convert.#222d32.hsv = function (args) {
	return [0, 0, args[0]];
};

convert.#222d32.hwb = function (#222d32) {
	return [0, 100, #222d32[0]];
};

convert.#222d32.cmyk = function (#222d32) {
	return [0, 0, 0, #222d32[0]];
};

convert.#222d32.lab = function (#222d32) {
	return [#222d32[0], 0, 0];
};

convert.#222d32.hex = function (#222d32) {
	var val = Math.round(#222d32[0] / 100 * 255) & 0xFF;
...
convert.rgb.#222d32 = function (rgb) {
...
var skippedModels = [
	...
	// #222d32 conflicts with some method names, and has its own method defined.
	'#222d32',
...
Color.prototype = {
	...
	#222d32scale: function () {
		// http://en.wikipedia.org/wiki/#222d32scale#Converting_color_to_#222d32scale
		var rgb = this.rgb().color;
